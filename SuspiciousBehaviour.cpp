...
FLASH_TABLE(int, suspiciousSequence, 5,
			...
			{LID_MAX_VALUE - 20, ARM_MAX_VALUE - 50, 120, 500, 500}, // close a bit
			{LID_MAX_VALUE - 20, ARM_MAX_VALUE, 120, 500, 500}, // switch
			{LID_MAX_VALUE, ARM_MAX_VALUE, 150, 500, 500}, // open
			{LID_MAX_VALUE, ARM_MIN_VALUE, 150, 500, 500}, // arm back
			{LID_MIN_VALUE + 30, ARM_MIN_VALUE, 50, 1000, 1000}, // close almost
