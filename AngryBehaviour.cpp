...
FLASH_TABLE(int, angrySequence, 5,
			...
			{LID_MAX_VALUE, ARM_MIN_VALUE, 150, 100, 500}, // fast open, wait a bit
			...
			{LID_MAX_VALUE, ARM_MAX_VALUE, 150, 100, 200}, // fast switch off
			{LID_MAX_VALUE, ARM_MIN_VALUE, 150, 100, 0}, // hand back in
